      ...
      <section className="flex flex-col gap-4 sm:gap-6">
        ...
        <div className="text-[#A4A4A4] flex flex-col gap-4 sm:gap-6 text-sm sm:text-base">
          ...
          <p>
            ...
            <span className="italic"> never</span> restricted by walls—like
            Hogwarts, imagination runs free here. If you're eager to experiment,
            collaborate, and bring your boldest ideas to life, we've got a{" "}
            <span className="italic">broomstick</span> ready for you to join
          ...
          <div className="text-[#A4A4A4]">
            ...
            <ul className="pl-4 list-decimal list-inside flex flex-col gap-2 sm:gap-3">
              <li>
                Would duel for creativity like a true{" "}
                <span className="italic">Triwizard Champion</span> 🏆
              </li>
              <li>
          ...
          <p className="font-bold">
            ...
            <span className="italic">
              If you're the wizard we're looking for, expect competitive
