    ...
    <div className="bg-black pt-[20px] flex flex-col">
      ...
      <div className="grid grid-cols-[repeat(6,1fr)] my-[20px] px-[40px] gap-[10px]">
        <div
          ...
          className={`${
            showProject === 1 ? "bg-white text-[#000000] " : ""
        ...
        <div
          ...
          className={`${
            showProject === 2 ? "bg-white text-[#000000]" : ""
          } border-[#2e2e2e] border-[1px] rounded-[10px] hover:bg-white text-white hover:text-black text-[18px] font-semibold text-center py-[15px] cursor-pointer `}
        >
          3D
        </div>
        ...
        <div
          ...
          className={`${
            showProject === 4 ? "bg-white text-[#000000]" : ""
          } border-[#2e2e2e] border-[1px] rounded-[10px] hover:bg-white text-white hover:text-black text-[18px] font-semibold text-center py-[15px] cursor-pointer `}
        >
          Interior Design
        </div>
        <div
          ...
          className={`${
            showProject === 5 ? "bg-white text-[#000000]" : ""
          } border-[#2e2e2e] border-[1px] rounded-[10px] hover:bg-white text-white hover:text-black text-[18px] font-semibold text-center py-[15px] cursor-pointer `}
        >
          Videography
        </div>
        <div
          onClick={() => setShowProject(6)}
          className={`${
            showProject === 6 ? "bg-white text-[#000000]" : ""
          } border-[#2e2e2e] border-[1px] rounded-[10px] hover:bg-white text-white hover:text-black text-[18px] font-semibold text-center py-[15px] cursor-pointer `}
        >
          Photography
        </div>
      </div>
      {showProject == 1 && <HomeProjectWeb />}
      {showProject == 2 && <HomeProject3D />}
      {showProject == 3 && <HomeProjectVFX />}
      {showProject == 4 && <HomeProjectInterior />}
      {showProject == 5 && <HomeProjectVideo />}
      {showProject == 6 && <HomeProjectPhoto />}
    </div>
  );
}
